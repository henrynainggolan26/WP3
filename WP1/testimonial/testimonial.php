...
function my_admin_menu() {
	add_menu_page( 'My Top Level Menu Example', 'Testimonial', 'manage_options', 'admin_testimonial/admin_testimonial_page.php', 'testimonial_admin_page', 'dashicons-tickets', 6  );
}
...
function show_testimonial(){
	...
	<?php
	global $wpdb;
	$result = $wpdb->get_results("SELECT * FROM users"); 
